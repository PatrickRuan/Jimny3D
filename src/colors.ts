...
export const PAINTS: PaintOption[] = [
  ...
  // === 獨家客製改裝色 (Custom Colors) ===
  {
    ...
    bodyHex: '#FEBD01',
    roofHex: '#111111',
    material: { metalness: 0.1, roughness: 0.12, clearcoat: 1.0, clearcoatRoughness: 0.03 },
    isTwoTone: true,
    category: 'custom',
  },
  {
    id: 'dream_brown_white',
    nameTw: '夢幻棕/白頂',
    nameEn: 'Dream Brown Pearl / Ivory White',
    bodyCode: 'CUSTOM-02',
    roofCode: 'ZVR',
    bodyHex: '#A2753E',
    roofHex: '#F4F3EF',
    material: { metalness: 0.3, roughness: 0.15, clearcoat: 1.0, clearcoatRoughness: 0.05 },
    isTwoTone: true,
    category: 'custom',
  },
];
